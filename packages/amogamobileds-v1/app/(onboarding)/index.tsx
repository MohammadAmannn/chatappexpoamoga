 ...
 * The intro carousel.
 *
 * Reached only when the signed-in user's `profiles.onboarded` is false — the
      ...
      steps={[
        {
          ...
          description:
            'Your tasks are a live Postgres subscription. Change one on another device and it lands here without a refresh.',
        ...
        },
        {
          ...
          description:
            'Row level security runs in the database, so another signed-in user cannot read your rows even if the app asks.',
        ...
        },
        {
          ...
          description:
            'Every screen, hook and SQL migration is in your repository. Change whatever you like.',
